...
public class NRDA_EnvironmentSectionLoginAs_Manager extends URLPageWSNRDAScript
{
	...
	public void NRDA_ENVIRONMENT_SC_10_TC_11(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			WaterAndSewerageLoginPage Login_M_ENV=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			Login_M_ENV.loginAsM_ENV(username, password);
	...
	public void NRDA_ENVIRONMENT_SC_10_TC_14(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			...
			Login_MENV.toVerifyErrorMsginCommentFieldisBlank();
		}
	
	
	@Test(dataProvider ="M-ENV",description="toVerify CloseButtonfunctionality",priority=15)
	public void NRDA_ENVIRONMENT_SC_10_TC_17(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			WaterAndSewerageLoginPage Login_M_ENV=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			Login_M_ENV.loginAsM_ENV(username, password);
	...
	public void NRDA_ENVIRONMENT_SC_10_TC_16_1(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
