...
//	}
	...
	@Test(dataProvider ="citizen",description="Verify the Functionality of Correspondence Address",priority=4)
...
//	@Test(dataProvider ="citizen",description="Verify the Functionality of Property Details",priority=5)
...
//		ToverifyFunctionalityof_Environment_Loginas_Citizen login_citizen=PageFactory.initElements(driver, ToverifyFunctionalityof_Environment_Loginas_Citizen.class);
//		login_citizen.verifytheDashBoardofEnvironmentNOC_SC_03_TC_02();
//		login_citizen.toclickomproceedbutton();
//		login_citizen.VerifyFunctionalityofPropertyDetails();
//	 }
	
	
	@Test(dataProvider ="citizen",description="Verify the Functionality of Type of NOC",priority=6)
	...
	@Test(dataProvider ="citizen",description="VerifythefunctionalityoftheSubmitbuttonwithoutenteranydetails_SC_03_TC_03",priority=7)
	public void NRDA_ENVIRONMENT_SC_03_TC_03(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	 {
		...
		login_citizen.verifytheDashBoardofEnvironmentNOC_SC_03_TC_02();
		login_citizen.toclickomproceedbutton();
		login_citizen.VerifythefunctionalityoftheSubmitbuttonwithoutenteranydetails_SC_03_TC_03();
	 }
	
	@Test(dataProvider ="citizen",description="VerifytheEnvironmentalApplicationfunctionalityfillbytheCitizens_NOC_IsProject",priority=8)
	...
	@Test(dataProvider ="citizen",description="VerifytheEnvironmentalApplicationfunctionalityfillbytheCitizens_NOC_IsIndividual",priority=9)
...
//	 }
	...
	@Test(dataProvider ="citizen",description="VerifySaveAsDraftButtonFunctionality",priority=10)
	...
	@Test(dataProvider ="citizen",description="VerifyBackButtonFunctionality",priority=11)
	...
	@Test(dataProvider ="citizen",description="VerifyDownloadFromProjectButtonFunctionality",priority=12)
	...
	@Test(dataProvider ="citizen",description="VerifyCloseButtonFunctionality",priority=13)
	...
	@Test(dataProvider ="citizen",description="VerifyResetButtonFunctionality",priority=14)
	...
	@Test(dataProvider ="citizen",description="VerifytheuploadfunctionalitywithInValidFile",priority=15)
	...
	@Test(dataProvider ="citizen",description="VerifytheuploadfunctionalitywithValidFile",priority=16)
	...
	@Test(dataProvider ="citizen",description="VerifytheSubmitButtonFunctionality",priority=17)
	...
	@Test(dataProvider ="citizen",description="VerifytheSubmittedApplication Menu As Citizen",priority=18)
	...
	@Test(dataProvider ="citizen",description="VerifytheFunctionality of submitted application status",priority=20)
	...
	@Test(dataProvider ="citizen",description="VerifySaveAsDraftButtonFunctionality",priority=21)
	...
	@Test(dataProvider ="citizen",description="VerifytheFunctionality of submitted application status",priority=22)
	...
	@Test(dataProvider ="citizen",description="VerifyDeleteButtonFunctionalityin Drafted Application",priority=23)
	...
	@Test(dataProvider ="citizen",description="VerifytheFunctionality of submitted application status",priority=24)
	...
	@Test(dataProvider ="citizen",description="Verify the Home Page of Citizen",priority=1)
	public void NRDA_ENVIRONMENT_SC_14_TC_01(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	 {
		WaterAndSewerageLoginPage logina_citizen=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
		logina_citizen.loginAsCitizen(username, password);
