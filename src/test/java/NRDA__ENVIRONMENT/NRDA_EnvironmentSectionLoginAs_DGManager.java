...
public class NRDA_EnvironmentSectionLoginAs_DGManager extends URLPageWSNRDAScript
{
	...
	public void NRDA_ENVIRONMENT_SC_11_TC_01(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			Login_DGM_ENV.toverifythedashboardoftheApplication();
	...
	public void NRDA_ENVIRONMENT_SC_11_TC_02(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			ToverifyFunctionalityof_EnvironmentSection_Loginas_DGManager Login_DGM_ENV=PageFactory.initElements(driver, ToverifyFunctionalityof_EnvironmentSection_Loginas_DGManager.class);
			Login_DGM_ENV.toVerifyPendingApplicationLink();
			Login_DGM_ENV.toVerifyPendingApplicationMenulist1();
	...
	public void NRDA_ENVIRONMENT_SC_11_TC_11(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			WaterAndSewerageLoginPage logina_DGM=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_DGM.loginAsDGM_ENV(username, password);
	...
	public void NRDA_ENVIRONMENT_SC_11_TC_17(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			WaterAndSewerageLoginPage logina_DGM=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_DGM.loginAsDGM_ENV(username, password);
	...
	public void NRDA_ENVIRONMENT_SC_11_TC_16(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			WaterAndSewerageLoginPage logina_DGM=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_DGM.loginAsDGM_ENV(username, password);
