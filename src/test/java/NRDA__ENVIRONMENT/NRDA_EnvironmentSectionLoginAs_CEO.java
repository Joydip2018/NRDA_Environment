...
public class NRDA_EnvironmentSectionLoginAs_CEO extends URLPageWSNRDAScript
{
	...
	public void NRDA_ENVIRONMENT_SC_12_TC_01(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			Login_CEO_ENV.toverifythedashboardoftheApplication();
		}
	...
	public void NRDA_ENVIRONMENT_SC_12_TC_02(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			ToverifyFunctionalityof_EnvironmentSection_Loginas_CEO Login_CEO_ENV=PageFactory.initElements(driver, ToverifyFunctionalityof_EnvironmentSection_Loginas_CEO.class);
			Login_CEO_ENV.toVerifyPendingApplicationLink();
			Login_CEO_ENV.toVerifyPendingApplicationMenulist1();
		}
	...
	public void NRDA_ENVIRONMENT_SC_12_TC_11(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			WaterAndSewerageLoginPage login_CEO=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			login_CEO.loginAsCEO_ENV(username, password);
