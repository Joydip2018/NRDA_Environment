...
public class NRDA_EnvironmentSectionLoginAs_Employee extends URLPageWSNRDAScript
{
	...
	@Test(dataProvider ="NRDA-EMPLOYEE",description="Verify the Home Page of Citizen",priority=1)
	public void NRDA_ENVIRONMENT_SC_13_TC_01(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			WaterAndSewerageLoginPage logina_citizen=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_citizen.loginAsEmployee(username, password);
	...
	@Test(dataProvider ="NRDA-EMPLOYEE",description="Verify the Pending Applications",priority=2)
	public void NRDA_ENVIRONMENT_SC_13_TC_02(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			WaterAndSewerageLoginPage logina_citizen=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_citizen.loginAsEmployee(username, password);
	...
	@Test(dataProvider ="NRDA-EMPLOYEE",description="toVerifyfunctionalityPendingApplicationbyselectingspecificapplication",priority=4)
	public void NRDA_ENVIRONMENT_SC_13_TC_03(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			WaterAndSewerageLoginPage logina_citizen=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_citizen.loginAsEmployee(username, password);
	...
	@Test(dataProvider ="NRDA-EMPLOYEE",description="toVerifyfunctionalityPendingApplicationbyselectingspecificapplication",priority=4)
	public void NRDA_ENVIRONMENT_SC_13_TC_04(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			WaterAndSewerageLoginPage logina_citizen=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_citizen.loginAsEmployee(username, password);
			...
			Login_Employee.toVerifyPendingApplicationWithValidNumber_SC_04_TC_03();
			Login_Employee.toVerifyfunctionalityPendingApplicationbyselectingspecificapplication_SC_04_TC_04();
			Login_Employee.toverifythefunctionalityofDownloadLetterforCollector_Button();
		}
	
	@Test(dataProvider ="NRDA-EMPLOYEE",description="toVerifyfunctionalityPendingApplicationbyselectingspecificapplication",priority=4)
	public void NRDA_ENVIRONMENT_SC_13_TC_05(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			WaterAndSewerageLoginPage logina_citizen=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_citizen.loginAsEmployee(username, password);
			...
			Login_Employee.toVerifyPendingApplicationWithValidNumber_SC_04_TC_03();
			Login_Employee.toVerifyfunctionalityPendingApplicationbyselectingspecificapplication_SC_04_TC_04();
			Login_Employee.toVerifyfunctionalitySelectingActionDropdownasVerify();
			Login_Employee.toverifythefunctionalityofUpdateNOCDetails();
