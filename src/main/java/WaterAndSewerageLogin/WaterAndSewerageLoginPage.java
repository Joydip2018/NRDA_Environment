...
public class WaterAndSewerageLoginPage extends BrowserDriver{
	...
	public void loginAsinvalidCitizen(String username,String Password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		emailid.clear();
		HighlightOnElement(emailid);
		excel.getExcelData(emailid, "Invalid Citizen Credentials", 0, 1);
		password.clear();
		HighlightOnElement(password);
		excel.getExcelData(password, "Invalid Citizen Credentials", 1, 1);
...
public void loginAsEmployee(String username,String Password) throws InterruptedException{
	...
	public void loginAsSE_Estate(String username,String Password) throws InterruptedException{
			emailid.clear();
			HighlightOnElement(emailid);
			emailid.sendKeys(username);
			String actual_username="pragyasahu06";
	...
	public void loginAsProject_Manager(String username,String Password) throws InterruptedException{
			emailid.clear();
			HighlightOnElement(emailid);
			emailid.sendKeys(username);
			String actual_username="manager_estate";
	...
	public void loginAsFinance_Manager(String username,String Password) throws InterruptedException{
			emailid.clear();
			HighlightOnElement(emailid);
			emailid.sendKeys(username);
			String actual_username="m_finance";
	...
	public void loginAsChiefEngineer(String username,String Password) throws InterruptedException{
			emailid.clear();
			HighlightOnElement(emailid);
			emailid.sendKeys(username);
			String actual_username="cee";
			...
			password.clear();
			password.sendKeys(Password);
			String actual_password="NRDA@183";
			Reporter.log("Password:"+Password,true);
			Assert.assertEquals(Password,actual_password);
	...
	public void loginAsChiefEngineerManager(String username,String Password) throws InterruptedException{
			emailid.clear();
			HighlightOnElement(emailid);
			emailid.sendKeys(username);
			String actual_username="cpm";
			//String actual_username="nsarvesh001@gmail.com";
			Reporter.log("Email ID:"+username,true);
			Assert.assertEquals(username,actual_username);
			...
			password.clear();
			password.sendKeys(Password);
			String actual_password="NRDA@182";
			Reporter.log("Password:"+Password,true);
			Assert.assertEquals(Password,actual_password);
	...
	public void loginasCitizen(String username,String Password) throws InterruptedException{
			...
			HighlightOnElement(emailid);
			emailid.sendKeys(username);
			String actual_username="aayu187@gmail.com";
			//String actual_username="nsarvesh001@gmail.com";
			Reporter.log("Email ID:"+username,true);
			Assert.assertEquals(username,actual_username);
      ...
      public void loginAsAM(String username, String Password) throws InterruptedException {
		emailid.clear();
		HighlightOnElement(emailid);
		emailid.sendKeys(username);
		String actual_username = "tehsildaar";
...
public void loginAsRI(String username, String Password) throws InterruptedException {
		emailid.clear();
		HighlightOnElement(emailid);
		emailid.sendKeys(username);
		String actual_username = "jsharma";
