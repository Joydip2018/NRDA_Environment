 ...
 *
 */
public class ToverifyRTILoginAsEEverified extends CommonLibrary 
{
	...
	@FindBy(xpath="//div[@id='inboxForm:j_id2115130985_7443e758:j_id2115130985_7443e7f0_16_paginator_bottom']//span[@class='ui-paginator-next ui-state-default ui-corner-all']")
	 WebElement next;
	...
	@FindBy(xpath="//input[@id='inboxForm:j_id2115130985_7443e758:j_id2115130985_7443e7f0_16:j_id2115130985_7443e41a_16:filter']")
	 WebElement Application_no;
	
	@FindBy(xpath="//a[@id='inboxForm:j_id2115130985_7443e758:j_id2115130985_7443e7f0_16:0:j_id2115130985_7443e4a0_16']//img")
	 WebElement Action;
	...
	@FindBy(xpath="//textarea[@id='inboxForm:docAccordionPanel:j_id530723777_9ce749b']")
	 WebElement Departmentalbox;
	...
	public void toverifythefunctionalityofactiondropdown() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		sel.selectByVisibleText("Verify");		
	...
	public void toverifytheRTIInformationtab1() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{		
		waitForPageLoad(driver,RTIInfoTab);
		HighlightOnElement(RTIInfoTab);
		RTIInfoTab.click();
		...
		waitForSomeTime();
		waitForPageLoad(driver,sendback);
		HighlightOnElement(sendback);
		Assert.assertTrue(sendback.isEnabled(),"TestCase Pass:sendback");
		sendback.click();
		waitForSomeTime();
		Reporter.log("Application sendback successfully",true); //print for eclipse console		
	}
	...
	public void toverifytheDepartmentalbox() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		waitForSomeTime();waitForSomeTime();waitForSomeTime();
		ScroolDown();
		waitForPageLoad(driver,Departmentalbox);
		HighlightOnElement(Departmentalbox);
		Assert.assertTrue(Departmentalbox.isEnabled(),"TestCase Pass:Departmentalbox");
		Reporter.log("Departmentalbox is prasent",true); //print for eclipse console
		Departmentalbox.click();
		Departmentalbox.sendKeys("Done");	
	}
