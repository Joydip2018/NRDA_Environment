...
public class BrowserDriver extends CommonLibrary implements ConstantI {
	...
	static String chromeDriverPath = ".\\src\\main\\resources\\chromedriver2.exe";

	static String IE_DriverKey = "webdriver.ie.driver";
	static String IE_DriverPath = ".\\src\\main\\resources\\IEDriverServer.exe";

	static String firefoxDriverKey = "webdriver.gecko.driver";
	static String firefoxDriverPath = ".\\src\\main\\resources\\geckodriver.exe";

	static String DownloadPDF = ".\\DownloadFile";
