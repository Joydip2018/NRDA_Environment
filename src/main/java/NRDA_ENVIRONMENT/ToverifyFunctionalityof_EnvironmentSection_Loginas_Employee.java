...
public class ToverifyFunctionalityof_EnvironmentSection_Loginas_Employee extends CommonLibrary 
{
	...
	@FindBy(xpath="//span[contains(.,'Basic Details')]/../following-sibling::div/table/tbody/tr/td/label")
	...
	@FindBy(xpath="(//div/div//span[contains(.,'Basic Details')])[3]")
...
//		}
	...
	@FindBy(xpath="//span[contains(.,'Action and Comment')]/../following-sibling::div/center/table[2]/tbody/tr[3]/td[2]/div/div/textarea")
	private WebElement EnterCommentsField;
	
	@FindBy(xpath="//span[contains(.,'Action and Comment')]/../following-sibling::div/center/table[2]/tbody/tr[6]/td/div/div/textarea")
	...
	@FindBy(xpath="//span[contains(.,'Create File')]/../following-sibling::div/div/div/table/tbody/tr[2]/td[2]/div/div[3]/span")
	private WebElement Type_Dropdown;
	
	//@FindBy(xpath="//table[@class='ui-panelgrid ui-widget']/tbody/tr[2]/td[6]/div/div/span")
	@FindBy(xpath="//span[contains(.,'Create File')]/../following-sibling::div/div/div/table/tbody/tr[2]/td[4]/div/div[3]/span")
	private WebElement Category_Dropdown;
	
	//@FindBy(xpath="//table[@class='ui-panelgrid ui-widget']/tbody/tr[3]/td[3]/div/div/span")
	@FindBy(xpath="//span[contains(.,'Create File')]/../following-sibling::div/div/div/table/tbody/tr[3]/td[2]/div/div[3]/span")
	...
	@FindBy(xpath="//span[contains(.,'Action and Comment')]/../following-sibling::div/center/table[2]/tbody/tr[1]/td[2]/input")
	...
	{		
		...
		String ExpectedMessage="Invalid file uploaded. Kindly upload valid file (.jpeg, .jpg, .pdf & .png).";
	...
	private WebElement Successful_MSG1;
	...
	public void toVerifyfunctionalityofSubmitButton_SC_04_TC_10() throws InterruptedException
	{
		...
		waitForSomeTime();
		waitForSomeTime();
		HighlightOnElement(Successful_MSG1);
		String ActualMessage=Successful_MSG1.getText();
...
//		SelectVisibleText(Language_Dropdown, "English to Hindi");
	...
	@FindBy(xpath="//button[contains(.,'Download Letter For Collector')]")
	//@FindBy(xpath="//span[contains(.,'Action and Comment')]/../following-sibling::div/center/table[1]/tbody/tr/td/select")
	private WebElement DownloadLetterforCollector_Button;
	
	public void toverifythefunctionalityofDownloadLetterforCollector_Button() throws InterruptedException
	{
		waitForDomElement();
		HighlightOnElement(DownloadLetterforCollector_Button);
		DownloadLetterforCollector_Button.click();
		Thread.sleep(15000);
		waitForSomeTime();
		waitForSomeTime();
	...
	public void toVerifyfunctionalitySelectingActionDropdownasVerify() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	...
	@FindBy(xpath="//button[contains(.,'Update NOC Details')]")
	//@FindBy(xpath="//span[contains(.,'Action and Comment')]/../following-sibling::div/center/table[1]/tbody/tr/td/select")
	private WebElement UpdateNOCDetails;
	
	@FindBy(xpath="//span[contains(.,'Update Details')]/../following-sibling::div/div/div/table/tbody/tr[1]/td[2]/input")
	private WebElement NOCNo_Field;
	
	@FindBy(xpath="//span[contains(.,'Update Details')]/../following-sibling::div/div/div/table/tbody/tr[2]/td[2]/span")
	private WebElement Issuedon_Field;
	
	@FindBy(xpath="//table[@class='ui-datepicker-calendar']/tbody/tr/td/a[contains(.,'18')]")
	private WebElement Today_Date;
	
	@FindBy(xpath="//span[contains(.,'Update Details')]/../following-sibling::div/div/div/table/tbody/tr[3]/td[2]/input")
	private WebElement IssuedBy_Field;
	
	@FindBy(xpath="//span[contains(.,'Update Details')]/../following-sibling::div/div/div/table/tbody/tr[4]/td[2]/div/div[3]/span")
	private WebElement NoC_Dropdown;
	
	@FindBy(xpath="//span[contains(.,'Update Details')]/../following-sibling::div/div/div/table/tbody/tr[5]/td[2]/textarea")
	private WebElement Remarks_Field;
	
	@FindBy(xpath="//span[contains(.,'Update Details')]/../following-sibling::div/div/div/table/tbody/tr[6]/td[2]/table/tbody/tr[1]/td/div/div[1]/label")
	private WebElement UploadDocument;
	
	@FindBy(xpath="//span[contains(.,'Update Details')]/../following-sibling::div/div/div/center/table/tbody/tr/td/button[contains(.,'Submit')]")
	...
	public void toverifythefunctionalityofUpdateNOCDetails() throws InterruptedException, AWTException
	{
		waitForDomElement();
		HighlightOnElement(UpdateNOCDetails);
		UpdateNOCDetails.click();
		//Thread.sleep(9000);
		waitForSomeTime();
		waitForSomeTime();
		HighlightOnElement(NOCNo_Field);
		NOCNo_Field.sendKeys("272");
		waitForSomeTime();
		HighlightOnElement(Issuedon_Field);
		Issuedon_Field.click();
		waitForSomeTime();
		waitForSomeTime();
		HighlightOnElement(Today_Date);
		Today_Date.click();
		waitForSomeTime();
		HighlightOnElement(IssuedBy_Field);
		IssuedBy_Field.sendKeys("Officer");
		waitForSomeTime();
		/*HighlightOnElement(NoC_Dropdown);
		NoC_Dropdown.click();
		...
		waitForSomeTime();
		Remarks_Field.sendKeys("No Remarks");
		waitForSomeTime();
		waitForSomeTime();
		HighlightOnElement(UploadDocument);
		UploadDocument.click();
		waitForSomeTime();
		UpLoadFile("C:\\ILFS\\NRDA\\workspace\\NRDA_FRAMEWORK\\NRDA_PROJECT\\DownloadFile\\182018071600272_NOTESHEET (3).pdf");
		System.out.println("Upload Document Link Application of Water and Sewerage Environment Section is Present" ); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		...
		waitForSomeTime();
		waitForSomeTime();
		CommentsField.sendKeys("verified");
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		Submit_Button.click();
