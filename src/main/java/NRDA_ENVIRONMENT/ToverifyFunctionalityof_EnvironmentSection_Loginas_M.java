...
public class ToverifyFunctionalityof_EnvironmentSection_Loginas_M extends CommonLibrary 
{
	...
	public void toverifythefunctionalityofsearchfiledasApplicationNumberAsEnterNumericonly() throws InterruptedException
	{
		HighlightOnElement(ApplicationNumberField);
		ApplicationNumberField.sendKeys("978766565656767");
		waitForSomeTime();
		waitForSomeTime();
		HighlightOnElement(Error_Message);
	...
	public void toverifythefunctionalityofsearchfiledasApplicationNumberAsEnterAlphabetonly() throws InterruptedException
	{
		HighlightOnElement(ApplicationNumberField);
		ApplicationNumberField.sendKeys("sarvesh");
		waitForSomeTime();
		waitForSomeTime();
		HighlightOnElement(Error_Message);
...
//		}
	...
	@FindBy(xpath="//span[contains(.,'Action and Comment')]/../following-sibling::div/center/table[2]/tbody/tr/td/div/div/textarea")
	...
	public void toVerifyfunctionalitySelectingActionDropdownasForward() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		selectValueFromDropdown1("Shrivastava (EE)");
		waitForSomeTime();
		waitForSomeTime();
