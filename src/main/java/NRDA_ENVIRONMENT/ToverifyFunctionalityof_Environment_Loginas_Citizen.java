...
public class ToverifyFunctionalityof_Environment_Loginas_Citizen extends CommonLibrary 
{
	...
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/div[1]/div[1]/table/tbody/tr/td/div/h3/following-sibling::div/table/tbody/tr/td/label[contains(.,'ENVIRONMENT NOC')]/../following-sibling::td/span/a/img[@src='/NRDAuthorityPreUAT/javax.faces.resource/applyNow.png.xhtml?ln=img']")
	...
	@FindBy(xpath="//div[@class='ui-panel ui-widget ui-widget-content ui-corner-all']/div[2]/div/div/div[1]/span/center/table/tbody/tr/td/span/button")
	private List <WebElement> EnvironmentNOC_ButtonsList;
	
	@FindBy(xpath="//a[contains(.,'Upload Document')]/../../following-sibling::div/div[4]/span[2]/center/table/tbody/tr/td/span/button[contains(.,'Save As Draft')]")
	private WebElement SaveAsDraft_Button;
	
	@FindBy(xpath="//a[contains(.,'Upload Document')]/../../following-sibling::div/div[4]/span[2]/center/table/tbody/tr/td/span/button[contains(.,'Reset')]")
	private WebElement Reset_Button;
	
	@FindBy(xpath="//a[contains(.,'Upload Document')]/../../following-sibling::div/div[4]/span[2]/center/table/tbody/tr/td/span/button[contains(.,'Close')]")
	private WebElement Close_Button;
	
	@FindBy(xpath="//a[contains(.,'Upload Document')]/../../following-sibling::div/div[4]/span[2]/center/table/tbody/tr/td/span/button[contains(.,'Back')]")
	private WebElement Back_Button;
	
	@FindBy(xpath="//a[contains(.,'Upload Document')]/../../following-sibling::div/div[4]/span[2]/center/table/tbody/tr/td/span/button[contains(.,'Download Project form')]")
	private WebElement DownloadProjectform_Button;
	
	@FindBy(xpath="//a[contains(.,'Upload Document')]/../../following-sibling::div/div[4]/span[2]/center/table/tbody/tr/td/span/button[contains(.,'Submit')]")
	...
	@FindBy(xpath="(//span[contains(.,'Confirm Action')]/../following-sibling::div/div/div/div/div[1]/table/tbody/tr/td/button[contains(.,'Delete')])[1]")
	...
	public void verifytheDashBoardofEnvironmentNOC_SC_03_TC_02() throws InterruptedException
	{
		...
		Reporter.log("Verify Application of Environment_NOC link is Present",true); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		...
		waitForSomeTime();
		Thread.sleep(15000);
		//waitForelementPresent(Title_Dropdown);
	...
	public void toclickonDeletebutton() throws InterruptedException
	{
		waitForSomeTime();
	...
	@FindBy(xpath="//a[contains(.,'Basic Details')]/../../following-sibling::div/div[1]/span[1]/center/table/tbody/tr/td/span/button[contains(.,'Reset')]")
	...
	public void VerifyFunctionalityofBasicDetailForm() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		Reporter.log("Verify Application of environment Title_Dropdown is Present",true); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
	...
	public void VerifyFunctionalityofCorrespondenceAddress() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		waitForSomeTime();
		waitForSomeTime();
		waitForelementPresent(State_Dropdown);
...
*/
	...
	@FindBy(xpath="//img[@src='/NRDAuthorityPreUAT/javax.faces.resource/images/search-aadhar.png.xhtml']")
	private WebElement Search_IMG;
	
	@FindBy(xpath="//span[contains(.,'Search Your Property')]/../following-sibling::div[1]/div/div/span[1]/table/tbody/tr/td/div/div[3]/span")
	private WebElement Sector_Dropdown;
	
	@FindBy(xpath="//span[contains(.,'Search Your Property')]/../following-sibling::div[1]/div/div/span[2]/center/button[contains(.,'Search')]")
	private WebElement SearchButton;

	
	@FindBy(xpath="(.//*[@id='form0:propertyList_data']/tr/td[1]/div/div[2])[1]")
	...
	public void VerifyFunctionalityofPropertyDetails() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		waitForSomeTime();
		Reporter.log("Verify Application ofenvironment PropertyDetails_TAB is Present",true); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		...
		HighlightOnElement(Search_IMG);
		Assert.assertEquals(true,Search_IMG.isEnabled());
		Search_IMG.click();
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		waitForelementPresent(Sector_Dropdown);
	...
	@FindBy(xpath="//span[contains(.,'Search Your Property /अपनी संपत्ति खोजें')]/../following-sibling::div[1]/div/div/span[1]/table/tbody/tr[2]/td[3]/div/div[3]/span")
	private WebElement SectorDropdown;
	
	@FindBy(xpath="//span[contains(.,'Search Your Property /अपनी संपत्ति खोजें')]/../following-sibling::div[1]/div/div/span[2]/center/button[contains(.,'Search')]")
	private WebElement SearchButton1;
	
	@FindBy(xpath="//span[contains(.,'Search Your Property /अपनी संपत्ति खोजें')]/../following-sibling::div[1]/div/div/span[3]/div/div[1]/table/tbody/tr[1]/td[1]/div/div[2]")
	private WebElement CheckBox1;
	
	@FindBy(xpath=".//*[@id='form0:j_id1542663399_1b33763f']")
	...
	public void toverifyFunctionalityofTypeofNOC() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	{
		...
		SelectVisibleText(TypeofNOC_Dropdown, "Individual NOC / व्यक्तिगत एनओसी");
		Reporter.log("Verify Application of Water and Sewerage State_Dropdown is Present",true); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		...
		waitForSomeTime();
		waitForSomeTime();
		HighlightOnElement(SearchProperty);
		...
		SelectVisibleText(PurposeofNOC_Dropdown, "Tree Plantation /वृक्षारोपण");
...
*/				
		...
		Reporter.log("Verify Application ofEnvironment TotalTreeCount_Field is Present",true); //print for eclipse console
		waitForSomeTime();
		/*Thread.sleep(10000);
		waitForSomeTime();
	...
	public void toverifythefunctionalityof_UploadingDocument() throws InterruptedException, AWTException
	  {
		...
		waitForSomeTime();
		waitForSomeTime();
		Reporter.log("Verify Application of NRDA Environment Upload_Button  is Present",true); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
	...
	public void VerifythefunctionalityoftheSubmitbuttonwithoutenteranydetails_SC_03_TC_03() throws InterruptedException
	{
		waitForDomElement();
		HighlightOnElement(Upload_DocumentTab);
	...
	@FindBy(xpath="//div[@class='ui-panel ui-widget ui-widget-content ui-corner-all']/div[2]/div/div//div[3]/div/div[2]/div/button[contains(.,'Add More')]")
	private WebElement AddMore_Button;
	
	@FindBy(xpath="//div[@class='ui-panel ui-widget ui-widget-content ui-corner-all']/div[2]/div/div//div[3]/div/div[2]/div/button[contains(.,'Delete row')]")
	...
	@FindBy(xpath="(//div[@class='fileupload-buttonbar ui-widget-header ui-corner-top']/label)[1]")
...
*/
	...
	public  void VerifytheEnvironmentalApplicationfunctionalityfillbytheCitizens_NOC_IsProject_SC_03_TC_04() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		...
		HighlightOnElement(TypeofNOC_Dropdown);
		Assert.assertEquals(true,TypeofNOC_Dropdown.isEnabled());
		SelectVisibleText(TypeofNOC_Dropdown, "Project / परियोजना");
		Reporter.log("Verify Application of Water and Sewerage State_Dropdown is Present",true); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		...
		Reporter.log("Applicant AddressProof Document Link Application of Environment link is Present",true); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
	...
	public  void VerifyBackButtonFunctionality_SC_03_TC_09() throws InterruptedException
	{
		...
		HighlightOnElement(TypeofNOC_TAB);
		Assert.assertEquals(true,TypeofNOC_TAB.isEnabled());
		Reporter.log("Verify Application of  is TypeofNOC_TAB Present",true); //print for eclipse console 
		waitForSomeTime();
		waitForSomeTime();
	}
	...
	public  void VerifyDownloadFromProjectButtonFunctionality_SC_03_TC_10() throws InterruptedException
	{
		...
		waitForSomeTime();
		waitForSomeTime();
		Reporter.log("Verify Application of DownloadProjectform_Button is Present",true); //print for eclipse console 
		waitForSomeTime();
	...
	@FindBy(xpath="//div[@id='form0:confirmDlg']/div[2]/div/div/center/table/tbody/tr/td/button[contains(.,'Yes')]")
	...
	public  void VerifytheuploadfunctionalitywithInValidFile_SC_03_TC_16() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		...
		String ExpectedMsg="Please select actual file, changed extension and .exe not allowed.";
	...
	public  void VerifytheSubmitButtonfunctionality_SC_03_TC_18() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		...
		waitForSomeTime();
		Thread.sleep(30000);
		//waitForelementPresent(EnvironmentApplicationNumber);
