...
public class ToverifyFunctionalityof_CPM_Project_Scrutiny extends CommonLibrary {
	...
	@FindBy(xpath="//span[contains(.,'Fill Check List')]/../following-sibling::div[1]/div/div/table/tbody/tr[1]/td[5]/div/div[3]/span")
	private WebElement ApplicationIdProofDropdown;
	
	@FindBy(xpath="//span[contains(.,'Fill Check List')]/../following-sibling::div[1]/div/div/table/tbody/tr[2]/td[5]/div/div[3]/span")
	private WebElement AddressIdProofDropdown;
	
	@FindBy(xpath="//span[contains(.,'Fill Check List')]/../following-sibling::div[1]/div/div/table/tbody/tr[3]/td[5]/div/div[3]/span")
	private WebElement EMDFeesPaid_Dropdown;
	
	@FindBy(xpath="//span[contains(.,'Fill Check List')]/../following-sibling::div[1]/div/div/table/tbody/tr[4]/td[5]/div/div[3]/span")
	...
	public void toverifyEnterCommentsField() throws InterruptedException
	{
		...
		waitForSomeTime();
		waitForSomeTime();
		CommentsField.sendKeys("Project Scrutiny Request Forwarded to GM ");
		waitForSomeTime();
		waitForSomeTime();
